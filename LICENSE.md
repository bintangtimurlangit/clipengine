...
- Content of branches other than the default branch (`main`) is not
  licensed.
- All third party components incorporated into the ClipEngine software
  are licensed under the original license provided by the owner of the
  applicable component.
- Content outside the above mentioned files or restrictions is
  available under the "Sustainable Use License" as defined below.
...
software. Any use of the licensor's trademarks is subject to
applicable law.
...
software, you must include in any modified copies of the software a
...
The "licensor" is Bintang Timurlangit.
...
Copyright © 2026 Bintang Timurlangit. All rights reserved.
