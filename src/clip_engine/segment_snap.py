...
from clip_engine.models import ClipItem, TranscriptSegment, TranscriptDoc
...
def _slack_s() -> float:
    ...
    raw = os.environ.get("CLIP_ENGINE_SNAP_DURATION_SLACK_S")
...
def snap_clip_to_transcript(
    ...
    *,
    ...
    differ by a few seconds (see ``CLIP_ENGINE_SNAP_DURATION_SLACK_S``, default 3).
