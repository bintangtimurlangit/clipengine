...
from clip_engine.ffmpeg_ops import FFmpegError, ensure_ffmpeg, probe_duration_s
from clip_engine.llm import (
    LONGFORM_MAX_DURATION_S,
    LONGFORM_MIN_DURATION_S,
    SHORTFORM_MAX_DURATION_S,
    SHORTFORM_MIN_DURATION_S,
)
from clip_engine.models import ClipItem, CutPlan, TranscriptDoc
from clip_engine.segment_snap import snap_clip_to_transcript
...
def render_plan(
    ...
    *,
    ...
    few seconds vs the plan; see ``CLIP_ENGINE_SNAP_DURATION_SLACK_S`` in ``segment_snap``.
    """
